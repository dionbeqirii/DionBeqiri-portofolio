      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-slate-500 max-w-xl">
            From enterprise ERP customization to modern full-stack engineering —
            a complete toolkit for building real solutions.
          </p>
        </motion.div>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-3 mb-6 relative">
                  <div
                    className={`w-10 h-10 rounded-xl bg-gradient-to-br ${category.color} flex items-center justify-center shadow-lg flex-shrink-0`}
                  >
                    ...
                    <div key={skill.name}>
                      ...
                      <div className="h-1.5 bg-slate-800 rounded-full overflow-hidden">
                        <motion.div
                          ...
                          transition={{
                            duration: 1,
                            delay: catIdx * 0.12 + skillIdx * 0.08 + 0.3,
                            ease: "easeOut",
                          }}
                        />
                      </div>
